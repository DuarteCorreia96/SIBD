...
<html>
  ...
  <body>
    <?php
      ...
      $form_types = ['number', 'text', 'select', 'hidden', 'number', 'number', 'number', 'number', 'hidden'];
      $form_action = "insert_procedure.php";
      $default_values = [NULL, NULL, $VAT_assis, 'Blood', 100, 20, 100, 50, base64_encode(serialize($Indicators))];
